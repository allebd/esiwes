<?php
        ...
        if($_POST['logbookDesc'] == '')
        {
                        ...
                        || ($_FILES['logbookAttach']['name'] == ''))
                {
                        ...
                        $newprogress = mysql_query("INSERT INTO logbook (logbookMat, logbookDesc, logbookAttach, logbookDate, logbookTime) 
                                VALUES ('$logbookMat', '$logbookDesc','$logbookAttach','$logbookDate', '$logbookTime')", $connection);
