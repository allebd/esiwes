<?php 
    ...
    $getadmins = "SELECT * FROM stafflist INNER JOIN staffrole ON stafflist.staffno = staffrole.staffNum WHERE staffdelete = '' AND staffno NOT IN ('$staffno')";
								...
								<tbody>
									...
									<tr>
										...
										<?php 
	    									...
	    									$thestdnts = mysql_query($getsdntno); 
	    									if($thestdnts)
	    									{
	    										$stdnts = mysql_num_rows($thestdnts); 
	    									}else{
	    										$stdnts = 0;
	    									}
	    								?>
