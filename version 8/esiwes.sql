...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 18, 2023 at 10:57 PM
...
--
ALTER TABLE `logbook`
  MODIFY `logbookId` int(255) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `siwespost`
  MODIFY `siwesPostId` int(255) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `stafflist`
--
ALTER TABLE `stafflist`
  MODIFY `staffId` int(255) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `staffrole`
--
ALTER TABLE `staffrole`
  MODIFY `staffRoleId` int(255) NOT NULL AUTO_INCREMENT;
