<?php 
    ...
    $siwespost = mysql_query($getsiwes);
			...
			<div class="row">
				<div class="col-sm-8 page-content">
					<div class="white-container mb0">
						...
						<?php while($siwesrow = mysql_fetch_array($siwespost)){ ?>
						...
						<?php } ?>
						<?php if(mysql_num_rows($thepost) < 1) {?>
						...
						<?php }else{?>
							<table class="table-hover">
								...
								<tbody>	
								<?php while($stdntrow = mysql_fetch_array($thepost)){ ?>							
									<tr>
